...
INSERT INTO `mantis_api_token_table` VALUES (2,1,'ResolveCore','e157f544b21720bf841fdc34f2caf8c481ab7b17b267a31078d545848ee9bc33',1779111520,1779179693);
...
INSERT INTO `mantis_bug_history_table` VALUES (1,1,1,'','','',1,1779111602),(2,1,2,'','','',1,1779178656),(3,1,3,'','','',1,1779179038),(4,1,4,'','','',1,1779179693);
...
INSERT INTO `mantis_bug_table` VALUES (1,1,1,0,0,30,50,70,10,10,10,10,1,'','','','','','',0,10,'[ResolveCore] Test desde terminal',0,0,'',1,1779111602,1,1779111602),(2,1,1,0,0,20,50,70,10,10,10,10,2,'','','','','','',0,10,'[ResolveCore] Otro — Test Manual',0,0,'',1,1779178656,1,1779178656),(3,1,1,0,0,40,50,70,10,10,10,10,3,'','','','','','',0,10,'[ResolveCore] Soporte — Test Manual',0,0,'',1,1779179038,1,1779179038),(4,1,1,0,0,40,50,70,10,10,10,10,4,'','','','','','',0,10,'[ResolveCore] Soporte — Test para Mariiaa',0,0,'',1,1779179693,1,1779179693);
...
INSERT INTO `mantis_bug_text_table` VALUES (1,'Prueba de conexión API','',''),(2,'**Remitente:** Test Manual  \n**Email:** test@example.org  \n**Tipo:** otro  \n\n---\n\nPrueba desde WP-CLI','',''),(3,'**Remitente:** Test Manual  \n**Email:** test@test.org  \n**Tipo:** soporte  \n\n---\n\nPrueba de tutorial — ignorar.','',''),(4,'**Remitente:** Test para Mariiaa  \n**Email:** marimariapchecoo@gmail.com  \n**Tipo:** soporte  \n\n---\n\nPrueba para que esta mujer de mis amores lo vea','','');
...
INSERT INTO `mantis_filters_table` VALUES (1,1,0,0,'','v9#{\"_version\":\"v9\",\"_view_type\":\"simple\",\"category_id\":[\"0\"],\"severity\":[0],\"status\":[0],\"highlight_changed\":6,\"reporter_id\":[0],\"handler_id\":[0],\"project_id\":[-3],\"resolution\":[0],\"build\":[\"0\"],\"version\":[\"0\"],\"hide_status\":[90],\"monitor_user_id\":[0],\"sort\":\"last_updated\",\"dir\":\"DESC\",\"per_page\":50,\"match_type\":0,\"platform\":[\"0\"],\"os\":[\"0\"],\"os_build\":[\"0\"],\"fixed_in_version\":[\"0\"],\"target_version\":[\"0\"],\"profile_id\":[0],\"priority\":[0],\"note_user_id\":[0],\"sticky\":true,\"filter_by_date\":false,\"start_month\":\"05\",\"end_month\":\"05\",\"start_day\":1,\"end_day\":\"18\",\"start_year\":\"2026\",\"end_year\":\"2026\",\"filter_by_last_updated_date\":false,\"last_updated_start_month\":\"05\",\"last_updated_end_month\":\"05\",\"last_updated_start_day\":1,\"last_updated_end_day\":\"18\",\"last_updated_start_year\":\"2026\",\"last_updated_end_year\":\"2026\",\"search\":\"\",\"view_state\":0,\"tag_string\":\"\",\"tag_select\":0,\"relationship_type\":-1,\"relationship_bug\":0,\"custom_fields\":[],\"_source_query_id\":1}');
...
INSERT INTO `mantis_project_table` VALUES (1,'ResolveCore',10,1,10,10,'','Plataforma de mantenimiento IT',1,1);
...
INSERT INTO `mantis_tokens_table` VALUES (2,1,5,'{\"filter\":true,\"sidebar\":false,\"assigned\":true}',1779111171,1810714795),(3,1,3,'4,3,2,1',1779111602,1779266097);
...
INSERT INTO `mantis_user_table` VALUES (1,'administrator','','root@localhost','c93ccd78b2076528346216b3b2f701e6',1,0,90,7,0,0,'ZiyoC1NlaoW9_en2u3lKz7aX9WkwcBcmctsLV8cWHqlcna13-cV8_DeShNsqgAz2',1779179697,1779110869);
...
-- Dump completed on 2026-05-19  8:37:30
