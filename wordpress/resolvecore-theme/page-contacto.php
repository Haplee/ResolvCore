...
(function() {
	...
	data.append('nonce', '<?php echo esc_js( wp_create_nonce( 'resolvecore_contact' ) ); ?>');

	try {
		var res = await fetch('<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>', { method:'POST', body:data });
