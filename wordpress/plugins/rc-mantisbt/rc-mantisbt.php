...
function rc_mantis_register_settings(): void {
	register_setting( 'rc_mantis_group', 'rc_mantis_url', array( 'sanitize_callback' => 'esc_url_raw' ) );
	register_setting( 'rc_mantis_group', 'rc_mantis_token', array( 'sanitize_callback' => 'sanitize_text_field' ) );
	register_setting( 'rc_mantis_group', 'rc_mantis_project_id', array( 'sanitize_callback' => 'absint' ) );
	register_setting( 'rc_mantis_group', 'rc_mantis_enabled', array( 'sanitize_callback' => 'absint' ) );
}
			...
			<p>
				...
				if ( isset( $_GET['rc_mantis_test'] ) && current_user_can( 'manage_options' ) ) {
					...
					if ( is_wp_error( $result ) ) {
						...
						$count = count( $result['projects'] ?? array() );
